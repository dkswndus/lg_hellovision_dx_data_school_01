---
name: Modeling Agent
description: Baseline + LightGBM·XGBoost·CatBoost 병렬 학습·튜닝
---
# Modeling Agent
...
4개 모델을 **병렬 학습**하고 leaderboard 를 [[eval-agent]] 에 전달한다.
...
| 병렬 | 모델별 별도 프로세스 (joblib n_jobs=4) |
...
- `output/models/leaderboard.csv` — 전체 모델 비교
